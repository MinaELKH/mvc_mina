        ...
        <div class="p-6">
            ...
            <form method="POST" action="" enctype="multipart/form-data" class="space-y-6" id="courseForm">
                ...
                <script>
                    ...
                    // Initialize Tagify with the tags list from database
                    ...
                    document.getElementById('courseForm').addEventListener('submit', function(e) {
                        ...
                        var tagifyInstance = input.tagify;
                        
                        
                        if (tagifyInstance) {
                            input.value = JSON.stringify(tagifyInstance.value);
                        }
                    });
                </script>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('courseForm').addEventListener('submit', (e) => {
            if (document.getElementById('type').value === 'texte' && contentInput.value.trim() === '') {
                e.preventDefault();
                document.getElementById('contentError').classList.remove('hidden');
            }
        });
